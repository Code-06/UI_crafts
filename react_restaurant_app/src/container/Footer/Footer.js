  ...
  <div className="app__bg app__footer section__padding" id="footer">
    ...
    <div className="app__footer-links">
      <div className="app__footer-links_contact">
        ...
        <p className="p__opensans">Lane Ends Bungalow, Whatcroft Hall Rudheath CW9 75G</p>
    ...
    <div className="footer__copyright">
      <p className="p__opensans" style={{ textAlign: "center" }}>2025 Mediterranean. All Rights reserved.</p>
    </div>
  </div>
);
